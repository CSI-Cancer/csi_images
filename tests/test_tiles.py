...
def test_getting_tiles():
    ...
    tiles = csi_tiles.get_tiles_by_row_col(scan, cols=[0])
    assert len(tiles) == scan.roi[0].tile_rows
    ...
    tiles = csi_tiles.get_tiles_by_xy_bounds(
        scan,
        (
